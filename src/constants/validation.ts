...
export const AMINO_ACID_COLOR_SCHEME:AminoAcidColorScheme = {
    'A': '#67E4A6', 'R': '#BB99FF', 'N': '#80BFFF', 'D': '#FCCAC', 'C': '#FFEA00', 'E': '#FCCAC'
...
export const ALLOWED_CHARACTERS_REGEX = new RegExp(`[${ALLOWED_CHARACTERS.join('')}]`, 'i');